...
export const initSocket = function(socket, serviceManager = ServiceManager.default, opts = {}) {
  ...
  serviceManager.on('serviceRemoved', removeServiceListener);
  socket.on('disconnect', () => {
    serviceManager.removeListener('serviceAdded', setupServiceListener);
    serviceManager.removeListener('serviceRemoved', removeServiceListener);
  });
};
